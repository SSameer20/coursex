...
export default function Home() {
  ...
  return (
    <div className="flex flex-col w-full h-screen items-center overflow-hidden home">
        <Button color="secondary" className="absolute top-5 right-5 z-10" onClick={()=>navigate(Routes.AUTH)}>Login</Button>
        ...
        <div className="absolute top-[50vh] w-1/4 z-10 flex flex-col gap-5 description">
            <span>CourseX is a modern web application designed to provide a platform for instructors to sell online courses and for students to purchase and learn from them.</span>
            <Button color='primary' onClick={handleLearn}>Learn</Button>
        </div>
        <Wallpaper />
    </div>
  )
